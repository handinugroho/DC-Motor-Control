...
void loop() {
  ...
  if ((currentMillis - previousMillis) > interval) {
    ...
    errorIntegral = (getPosition() - setPoint) * (millis() - previousTime) / 1000.0;
    errorDerivative = (error - lastError) * 1000.0 /(float)(millis() - previousTime);
    power = Kp*error + Ki*errorIntegral + Kd*errorDerivative;
